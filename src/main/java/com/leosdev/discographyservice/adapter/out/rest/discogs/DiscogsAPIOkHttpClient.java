package com.leosdev.discographyservice.adapter.out.rest.discogs;

import com.leosdev.discographyservice.application.port.in.model.ArtistGetQuery;
import com.leosdev.discographyservice.application.port.in.model.ArtistReleasesGetQuery;
import com.leosdev.discographyservice.application.port.in.model.ArtistSearchQuery;
...
public class DiscogsAPIOkHttpClient implements DiscogsAPIClient {
    ...
    private Request buildRequest(HttpUrl url) {
        return new Request.Builder()
                ...
                .addHeader("User-Agent", "leosdev-discography-service")
                .url(url)
                .get()
                .build();
    }
